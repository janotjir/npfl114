...
class Model(tf.keras.Model):
    def __init__(self, args: argparse.Namespace, train: MorphoDataset.Dataset) -> None:
        ...
        embeddings = tf.keras.layers.Embedding(train.forms.word_mapping.vocab_size(), args.we_dim)(indices)
        ...
        predictions = tf.keras.layers.Dense(train.tags.word_mapping.vocab_size(), activation=tf.nn.softmax)(hidden)
